      ...
      <div className="p-8 md:p-12">
        ...
        <div className="text-center space-y-4">
          ...
          <div className="mt-8 flex flex-col items-center">
            <a
              className="text-center bg-dark hover:bg-darker text-white font-semibold py-3 px-6 rounded-full shadow-md transition-colors duration-300 w-full md:w-auto"
